    ...
    <div class="bg-white dark:bg-gray-800 rounded-xl shadow-sm border border-gray-200 dark:border-gray-700 p-6">
        <div class="flex flex-col sm:flex-row sm:items-center sm:justify-between gap-4">
            <div class="flex items-center space-x-3">
                ...
                <div>
                    <h1 class="text-2xl font-bold text-gray-900 dark:text-white">Create Sub Category</h1>
                    <p class="text-sm text-gray-600 dark:text-gray-400">Add a new product sub category under a parent category</p>
                </div>
            </div>
        ...
        <div class="xl:col-span-2">
            <div class="bg-white dark:bg-gray-800 rounded-xl shadow-sm border border-gray-200 dark:border-gray-700 p-6">
                <div class="border-b border-gray-200 dark:border-gray-700 pb-4 mb-6">
                    ...
                    <p class="text-sm text-gray-600 dark:text-gray-400 mt-1">Fill in the details for your new sub category</p>
                </div>
                <form method="POST" action="{{ route('admin.sub-categories.store') }}" enctype="multipart/form-data" autocomplete="off">
                    @csrf
                    <div class="grid grid-cols-1 gap-6 md:grid-cols-2">
                        <div>
                            ...
                            <select name="category_id" required
                                    class="w-full rounded-lg border border-gray-300 dark:border-gray-600 bg-white dark:bg-gray-700 px-4 py-3 text-gray-900 dark:text-white transition-colors focus:border-blue-500 focus:ring-2 focus:ring-blue-500 focus:ring-offset-0 dark:focus:ring-offset-gray-800
                                           {{ $errors->has('category_id') ? 'border-red-500 focus:border-red-500 focus:ring-red-500' : '' }}">
                        ...
                        <div>
                            ...
                            <input type="text" name="name" value="{{ old('name') }}" placeholder="Enter sub category name" required
                                   class="w-full rounded-lg border border-gray-300 dark:border-gray-600 bg-white dark:bg-gray-700 px-4 py-3 text-gray-900 dark:text-white transition-colors focus:border-blue-500 focus:ring-2 focus:ring-blue-500 focus:ring-offset-0 dark:focus:ring-offset-gray-800
                    ...
                    <div class="mt-6">
                        ...
                        <textarea name="description" rows="4" placeholder="Enter sub category description"
                                  class="w-full rounded-lg border border-gray-300 dark:border-gray-600 bg-white dark:bg-gray-700 px-4 py-3 text-gray-900 dark:text-white transition-colors focus:border-blue-500 focus:ring-2 focus:ring-blue-500 focus:ring-offset-0 dark:focus:ring-offset-gray-800
                                         {{ $errors->has('description') ? 'border-red-500 focus:border-red-500 focus:ring-red-500' : '' }}">{{ old('description') }}</textarea>
                        @error('description')
                            <p class="mt-2 text-sm text-red-600 dark:text-red-400">{{ $message }}</p>
                        @enderror
                    </div>
                    <div class="mt-6">
                        ...
                        <p class="mt-2 text-sm text-gray-500 dark:text-gray-400">Upload an image for this sub category (max 2MB, JPG/PNG)</p>
                        @error('image')
                            <p class="mt-2 text-sm text-red-600 dark:text-red-400">{{ $message }}</p>
                        @enderror
                    </div>
        ...
        <div class="space-y-6">
            ...
            <div class="bg-white dark:bg-gray-800 rounded-xl shadow-sm border border-gray-200 dark:border-gray-700 p-6">
                <div class="border-b border-gray-200 dark:border-gray-700 pb-4 mb-6">
                    ...
                    <p class="text-sm text-gray-600 dark:text-gray-400 mt-1">Best practices for sub categories</p>
                </div>
                <ul class="space-y-4">
                    <li class="flex items-start gap-3">
                        ...
                        <div>
                            ...
                            <p class="text-sm text-gray-600 dark:text-gray-400">Assign this sub category to a main parent category.</p>
                        </div>
                    </li>
                    <li class="flex items-start gap-3">
                        ...
                        <div>
                            <p class="text-sm font-semibold text-gray-900 dark:text-white">Name & Slug</p>
                            <p class="text-sm text-gray-600 dark:text-gray-400">Choose a clear name. The slug will be auto-generated.</p>
                        </div>
                    </li>
                     <li class="flex items-start gap-3">
                        ...
                        <div>
                            ...
                            <p class="text-sm text-gray-600 dark:text-gray-400">Lower numbers will appear first in any listings.</p>
                        </div>
                    </li>
                    <li class="flex items-start gap-3">
