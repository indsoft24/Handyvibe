    ...
    <div class="grid grid-cols-12 gap-4 md:gap-6">
        ...
        <div class="col-span-12">
            <div class="flex items-center justify-between">
                <div>
                    <h1 class="text-2xl font-bold text-black dark:text-white">Create Sub Category</h1>
                    <p class="text-sm text-gray-600 dark:text-gray-400">Add a new product sub category</p>
                </div>
                    ...
                    <form method="POST" action="{{ route('admin.sub-categories.store') }}" enctype="multipart/form-data">
                        ...
                        <div class="mt-4">
                            ...
                            <textarea
                                ...
                                name="description" rows="4" placeholder="Enter sub category description">{{ old('description') }}</textarea>
                            @error('description')
                                <p class="mt-1 text-sm text-red-500">{{ $message }}</p>
                            @enderror
                        </div>
                        ...
                        <div class="mt-4">
                            ...
                            <p class="mt-1 text-sm text-gray-500">Upload an image for this sub category (max 2MB)</p>
                            @error('image')
                                <p class="mt-1 text-sm text-red-500">{{ $message }}</p>
                            @enderror
                        </div>
