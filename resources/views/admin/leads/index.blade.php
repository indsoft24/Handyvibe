    ...
    <div class="space-y-6">
            ...
            <div class="flex flex-col sm:flex-row sm:items-center sm:justify-between gap-4">
                <div class="flex items-center space-x-3">
                    ...
                    <div>
                        ...
                        <p class="text-sm text-gray-600 dark:text-gray-400">Manage and track customer leads</p>
                    </div>
                </div>
        ...
        <div class="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-4 gap-6">
            ...
            <div class="bg-white dark:bg-gray-800 rounded-xl shadow-sm border border-gray-200 dark:border-gray-700 p-6">
                <div class="flex items-center justify-between">
                    <div>
                        <p class="text-sm font-medium text-gray-600 dark:text-gray-400">Urgent Leads</p>
            ...
            <div class="bg-white dark:bg-gray-800 rounded-xl shadow-sm border border-gray-200 dark:border-gray-700 p-6">
                <div class="flex items-center justify-between">
                    <div>
                        <p class="text-sm font-medium text-gray-600 dark:text-gray-400">Follow-up Needed</p>
                        <p class="text-2xl font-bold text-gray-900 dark:text-white">{{ $stats['needs_follow_up'] }}</p>
                    </div>
                ...
                <div class="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-6 gap-4">
                    ...
                    <div>
                        ...
                        <select name="source"
                            ...
                            <option value="referral" {{ request('source') == 'referral' ? 'selected' : '' }}>Referral
                            </option>
                        </select>
                    </div>
                    <div>
                        ...
                        @forelse($leads as $lead)
                            <tr class="hover:bg-gray-50 dark:hover:bg-gray-700">
                                <td class="px-6 py-4 whitespace-nowrap">
                                    <div>
                                        <div class="text-sm font-medium text-gray-900 dark:text-white">{{ $lead->name }}
                                        </div>
                                        @if ($lead->company)
                                            <div class="text-sm text-gray-500 dark:text-gray-400">{{ $lead->company }}
                                            </div>
                                        @endif
                                    </div>
                                </td>
                                ...
                                <td class="px-6 py-4 whitespace-nowrap">
                                    <div class="text-sm text-gray-900 dark:text-white">
                                        {{ $lead->service_name ?: 'General Inquiry' }}
                                    </div>
                                    <div class="text-sm text-gray-500 dark:text-gray-400 capitalize">{{ $lead->type }}
                                    </div>
                                </td>
                                <td class="px-6 py-4 whitespace-nowrap">
                                    <span
                                        class="inline-flex items-center px-2.5 py-0.5 rounded-full text-xs font-medium {{ $lead->status_color }}">
                                        {{ ucfirst($lead->status) }}
                                    </span>
                                </td>
                                <td class="px-6 py-4 whitespace-nowrap">
                                    <span
                                        class="inline-flex items-center px-2.5 py-0.5 rounded-full text-xs font-medium {{ $lead->priority_color }}">
                                        {{ ucfirst($lead->priority) }}
                                    </span>
                                </td>
                                <td class="px-6 py-4 whitespace-nowrap">
                                    <span
                                        class="inline-flex items-center px-2.5 py-0.5 rounded-full text-xs font-medium {{ $lead->source_color }}">
                                        {{ ucfirst($lead->source) }}
                                    </span>
                                </td>
                                <td class="px-6 py-4 whitespace-nowrap text-sm text-gray-900 dark:text-white">
                                    {{ $lead->assignedAdmin ? $lead->assignedAdmin->name : 'Unassigned' }}
                                </td>
