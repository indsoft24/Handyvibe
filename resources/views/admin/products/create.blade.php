    ...
    <div class="grid grid-cols-12 gap-4 md:gap-6">
        ...
        <div class="col-span-12">
            <div class="flex items-center justify-between">
                <div>
                    <h1 class="text-2xl font-bold text-black dark:text-white">Create Product</h1>
                    <p class="text-sm text-gray-600 dark:text-gray-400">Add a new product</p>
                </div>
                ...
                <div class="p-7">
                    <form method="POST" action="{{ route('admin.products.store') }}" enctype="multipart/form-data">
                        ...
                        <div class="grid grid-cols-1 gap-4 md:grid-cols-3 mt-4">
                            ...
                            <div>
                                ...
                                <input type="number"
                                    ...
                                    name="stock_quantity" value="{{ old('stock_quantity', 0) }}" placeholder="0"
                                    min="0">
                        ...
                        <div class="mt-4">
                            ...
                            <p class="mt-1 text-sm text-gray-500">Upload the main product image (max 2MB)</p>
                        ...
                        <div class="mt-4">
                            ...
                            <p class="mt-1 text-sm text-gray-500">Upload additional product images (max 5 images, 2MB each)
                            </p>
                            @error('images')
                                <p class="mt-1 text-sm text-red-500">{{ $message }}</p>
                            @enderror
        ...
        <div class="col-span-12 xl:col-span-4">
                    ...
                    <ul class="space-y-3">
                        ...
                        <li class="flex items-start">
                            ...
                            <div>
                                ...
                                <p class="text-sm text-gray-500">Will be automatically generated from the name.</p>
                            </div>
                        </li>
                    </ul>
                </div>
            ...
            <div
                ...
                <div class="border-b border-stroke px-7 py-4 dark:border-strokedark">
                    <h3 class="font-medium text-black dark:text-white">Image Preview</h3>
                </div>
