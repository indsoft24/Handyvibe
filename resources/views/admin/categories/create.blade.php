    ...
    <div class="grid grid-cols-12 gap-4 md:gap-6">
        ...
        <div class="col-span-12">
            <div class="flex items-center justify-between">
                <div>
                    <h1 class="text-2xl font-bold text-black dark:text-white">Create Category</h1>
                    <p class="text-sm text-gray-600 dark:text-gray-400">Add a new product category</p>
                </div>
        ...
        <div class="col-span-12 xl:col-span-8">
            <div class="rounded-sm border border-stroke bg-white shadow-default dark:border-strokedark dark:bg-boxdark">
                <div class="border-b border-stroke px-7 py-4 dark:border-strokedark">
                    <h3 class="font-medium text-black dark:text-white">Category Information</h3>
                </div>
                <div class="p-7">
                    <form method="POST" action="{{ route('admin.categories.store') }}" enctype="multipart/form-data">
                        ...
                        <div class="mt-4">
                            ...
                            <p class="mt-1 text-sm text-gray-500">Upload an image for this category (max 2MB)</p>
                            @error('image')
                                <p class="mt-1 text-sm text-red-500">{{ $message }}</p>
                            @enderror
                        </div>
                    ...
                    <ul class="space-y-3">
                        <li class="flex items-start">
                            ...
                            <div>
                                ...
                                <p class="text-sm text-gray-500">Choose a clear, descriptive name for your category.</p>
                            </div>
                        </li>
                        <li class="flex items-start">
                            <svg class="mr-2 h-5 w-5 text-yellow-500 mt-0.5" fill="currentColor" viewBox="0 0 20 20">
                        ...
                        <li class="flex items-start">
                            ...
                            <div>
                                <p class="text-sm font-medium text-black dark:text-white">Sort Order</p>
                                <p class="text-sm text-gray-500">Lower numbers appear first in listings.</p>
                            </div>
                        </li>
                        <li class="flex items-start">
                            <svg class="mr-2 h-5 w-5 text-yellow-500 mt-0.5" fill="currentColor" viewBox="0 0 20 20">
