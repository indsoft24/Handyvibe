    ...
    <div class="grid grid-cols-12 gap-4 md:gap-6">
        ...
        <div class="col-span-12">
            <div class="flex items-center justify-between">
                <div>
                    <h1 class="text-2xl font-bold text-black dark:text-white">Categories</h1>
        ...
        <div class="col-span-12">
            <div class="rounded-sm border border-stroke bg-white shadow-default dark:border-strokedark dark:bg-boxdark">
                <div class="border-b border-stroke px-7 py-4 dark:border-strokedark">
                    <h3 class="font-medium text-black dark:text-white">All Categories</h3>
                </div>
                <div class="p-7">
                                    ...
                                    @foreach ($categories as $category)
                                        <tr class="border-b border-stroke dark:border-strokedark">
                                            <td
                                                ...
                                                <h5 class="font-medium text-black dark:text-white">{{ $category->id }}</h5>
                                            </td>
                                            ...
                                            <td class="border-b border-stroke py-5 px-4 dark:border-strokedark">
                                                <div>
                                                    <h5 class="font-medium text-black dark:text-white">{{ $category->name }}
                                                    </h5>
                                            ...
                                            <td class="border-b border-stroke py-5 px-4 dark:border-strokedark">
                                                <code
                                                    class="text-sm text-gray-600 dark:text-gray-400">{{ $category->slug }}</code>
                                            </td>
                                            <td class="border-b border-stroke py-5 px-4 dark:border-strokedark">
                                                <span
                                            ...
                                            <td class="border-b border-stroke py-5 px-4 dark:border-strokedark">
                                                <form method="POST"
                                                    ...
                                                    @csrf
                                                    <button type="submit"
                                                        class="inline-flex items-center rounded-full px-2.5 py-0.5 text-xs font-medium {{ $category->status ? 'bg-green-100 text-green-800' : 'bg-red-100 text-red-800' }}">
                                                        {{ $category->status ? 'Active' : 'Inactive' }}
                                                    </button>
                                                </form>
                                            </td>
                                            <td class="border-b border-stroke py-5 px-4 dark:border-strokedark">
                                                <p class="text-sm text-black dark:text-white">{{ $category->sort_order }}
                                                </p>
                                            </td>
                                            <td class="border-b border-stroke py-5 px-4 dark:border-strokedark">
