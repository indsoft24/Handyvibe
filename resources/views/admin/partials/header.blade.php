                ...
                <li>
                    <div class="relative">
                        <button @click="chatOpen = !chatOpen"
                            ...
                            <svg class="fill-current duration-300 ease-in-out" width="18" height="19"
                                viewBox="0 0 18 19" fill="none" xmlns="http://www.w3.org/2000/svg">
                                <path
                                    d="M10.9688 1.57495H7.03135C3.43135 1.57495 0.506348 4.41558 0.506348 7.90308C0.506348 11.3906 2.75635 13.8375 8.26885 16.3125C8.40947 16.3812 8.52197 16.5208 8.52197 16.6895V18.3281C8.52197 18.5625 8.70635 18.75 8.94072 18.75H10.9688C11.2031 18.75 11.3875 18.5625 11.3875 18.3281V16.6895C11.3875 16.5208 11.5 16.3812 11.6406 16.3125C17.1531 13.8375 19.4031 11.3906 19.4031 7.90308C19.4031 4.41558 16.4781 1.57495 12.8781 1.57495H10.9688ZM5.35315 7.90308C5.35315 7.52808 5.66572 7.21558 6.04072 7.21558C6.41572 7.21558 6.72815 7.52808 6.72815 7.90308C6.72815 8.27808 6.41572 8.59058 6.04072 8.59058C5.66572 8.59058 5.35315 8.27808 5.35315 7.90308ZM8.88135 7.90308C8.88135 7.52808 9.19385 7.21558 9.56885 7.21558C9.94385 7.21558 10.2563 7.52808 10.2563 7.90308C10.2563 8.27808 9.94385 8.59058 9.56885 8.59058C9.19385 8.59058 8.88135 8.27808 8.88135 7.90308ZM12.4097 7.90308C12.4097 7.52808 12.7222 7.21558 13.0972 7.21558C13.4722 7.21558 13.7847 7.52808 13.7847 7.90308C13.7847 8.27808 13.4722 8.59058 13.0972 8.59058C12.7222 8.59058 12.4097 8.27808 12.4097 7.90308Z"
                                    fill="" />
                            </svg>
                        </button>
                        ...
                        <div x-show="chatOpen" x-transition:enter="transition ease-out duration-300"
                            ...
                            x-transition:leave-end="opacity-0 scale-95" @click.outside="chatOpen = false"
                            class="absolute right-0 mt-4 w-80 rounded-sm border border-stroke bg-white shadow-xl dark:border-strokedark dark:bg-boxdark">
                            <div class="px-4 py-3 border-b border-stroke dark:border-strokedark">
                                <h3 class="text-sm font-medium text-black dark:text-white">Recent Chats</h3>
                            </div>
                            <ul class="max-h-80 overflow-y-auto">
                                <li class="px-4 py-3 border-b border-stroke dark:border-strokedark">
                                    <div class="flex items-center gap-3">
                                        ...
                                        <div class="flex-1">
                                            <p class="text-sm font-medium text-black dark:text-white">John Doe</p>
                                            <p class="text-xs text-gray-500 dark:text-gray-400">Hey, how are you?</p>
                                        </div>
                                        <div class="text-xs text-gray-500 dark:text-gray-400">2m</div>
                                    </div>
                                </li>
                                <li class="px-4 py-3 border-b border-stroke dark:border-strokedark">
                                    <div class="flex items-center gap-3">
                                        ...
                                        <div class="flex-1">
                                            <p class="text-sm font-medium text-black dark:text-white">Jane Smith</p>
                                            <p class="text-xs text-gray-500 dark:text-gray-400">Can we schedule a
                                                meeting?</p>
                                        </div>
                                ...
                                <li class="px-4 py-3">
                                    <div class="flex items-center gap-3">
                                        ...
                                        <div class="flex-1">
                                            <p class="text-sm font-medium text-black dark:text-white">Mike Johnson</p>
                                            <p class="text-xs text-gray-500 dark:text-gray-400">Thanks for the update!
                                            </p>
                                        </div>
                                        <div class="text-xs text-gray-500 dark:text-gray-400">1h</div>
                                    </div>
                                </li>
                            </ul>
                            <div class="px-4 py-3 border-t border-stroke dark:border-strokedark">
            ...
            <div class="relative">
                ...
                <div x-show="dropdownOpen" x-transition:enter="transition ease-out duration-300"
                    ...
                    <div class="flex items-center gap-3 px-4 py-3">
                        ...
                        <div>
                            <a href="#" class="text-sm font-medium text-black dark:text-white">Thomas Anree</a>
                            <p class="text-xs">UX Designer</p>
                        </div>
                    </div>
