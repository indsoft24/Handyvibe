...
Route::prefix('admin')->name('admin.')->middleware(['web'])->group(function () {
    ...
    Route::resource('products', ProductController::class); // Use route('admin.products.*') for admin product CRUD
...
Route::get('/ecommerce/products', [ProductController::class, 'index'])->name('ecommerce.products');
Route::get('/ecommerce/products/{id}', [ProductController::class, 'show'])->name('ecommerce.products.show');
